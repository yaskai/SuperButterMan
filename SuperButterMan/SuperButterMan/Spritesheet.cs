...
namespace SuperButterMan 
{
    public class Spritesheet
    {
        ...
        public void DrawFrameBasic(SpriteBatch spriteBatch, Vector2 position, int c, int r, bool flip) {
            SpriteEffects fx = SpriteEffects.None;
            if(flip) fx = SpriteEffects.FlipHorizontally;
            spriteBatch.Draw(this.frames[c, r], position, null,  Color.White, 0, Vector2.One, Vector2.One, fx,  2);
        }
    }
}
